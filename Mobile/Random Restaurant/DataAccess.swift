...
class DataAccess {
    ...
    private let modelName = "Random_Restaurant"
    var sqliteFileName = "RandomRestaurant.sqlite"
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.JHamblin.Random_Restaurant" in the application's documents Application Support directory.
